# CleanFlow: Professional Repo Skeleton
...
- `PRIVACY.md` structure: template pattern (local-only, Ollama, no telemetry) reusable for all RayStudio offline-AI tools

---

*CleanFlow: RayStudio · Rafael Yilmaz · MIT License · 2026*
